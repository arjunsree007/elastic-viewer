...
function ElasticBrowser() {
  ...
  function getPagedResults(index) {
    ...
    fetchData(query, field, index, filterArray);
  }

  const fetchData = async (searchQuery, searchField, fromIndex, filterArr) => {
  ...
  function searchFilters() {
    ...
    fetchData(query, field, searchIndex, filterArr);
  }

  function resetFilters() {
    setSelectedFilters([]);

    fetchData(query, field, searchIndex, []);
    setFilterArray([]);
  }
